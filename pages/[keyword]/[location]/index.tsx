...
const KeywordPillarPage = ({ result }: { result: CustomContent }) => {
  ...
  return (
    <>
      ...
      />
      <BusinessDescription4 keyword={keyword} content20={result?.content20} />
      <MainFeedback keyword={keyword} content21={result?.content21} />
      <SubFeedback />
      <FAQ keyword={keyword} content22={result?.content22} />
      <Articles keyword={keyword} content23={result?.content23} />
