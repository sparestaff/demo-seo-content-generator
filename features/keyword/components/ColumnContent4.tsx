...
const ColumnContent4 = () => {
  return (
    <div className="flex justify-between items-center max-w-6xl mx-auto px-10 py-20 rounded-lg bg-orange-50">
      <div>
        <Image
      ...
      <div className="grid grid-cols-1 content-center gap-10 w-1/2">
        ...
        <div>
          Custom content #19 | Lorem Ipsum is simply dummy text of the printing
