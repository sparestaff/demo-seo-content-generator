...
const BusinessDescription2 = ({ keyword }: { keyword: string | undefined }) => {
  return (
    <div className="text-center py-20 max-w-6xl mx-auto sm:px-5 md:px-5 lg:px-5 xl:px-0">
      ...
      <p className="py-5 w-4/5 mx-auto">
        ...
        technicians have fixed 40,000+ problems on PC computers, laptops, Apple
        Mac for home and small businesses that covered everything from removing
        viruses, to water damage laptop repairs. We are proficient with all
        makes: Dell, Lenovo, HP, Apple, Acer, ASUS, Gigabyte, Clevo, Razer,
        Samsung, Toshiba, Sony and many more.
      </p>
    </div>
  );
};
